        ...
        >
           <div className='relative w-full h-[230px]'>
            ...
            <div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
                 <a href={source_code_link} className='black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer'>
  ...
  return (
    <>
       <motion.div variants={textVariant()}>
          ...
          <h2 className={`${styles.heroHeadText}`}>Best Projects.</h2>
       </motion.div>
